...
export class Read implements Action {
  readonly type: Types.READ = Types.READ;

  constructor() {}
}

export class ReadSuccess implements Action {
  readonly type: Types.READ_SUCCESS = Types.READ_SUCCESS;

  constructor(public items: Job[]) {}
}

export class ReadError implements Action {
  readonly type: Types.READ_ERROR = Types.READ_ERROR;
...
export class Delete implements Action {
  readonly type: Types.DELETE = Types.DELETE;

  constructor(public id: string) {}
}

export class DeleteSuccess implements Action {
  readonly type: Types.DELETE_SUCCESS = Types.DELETE_SUCCESS;

  constructor(public id: string) {}
}

export class DeleteError implements Action {
  readonly type: Types.DELETE_ERROR = Types.DELETE_ERROR;
